---
title: "idryer-coreとは何か、いつ使うか"
description: "idryer-coreの目的: ESP32ベースのiDryerデバイス向け共通ライブラリ、MQTT、Wi-Fi、テレメトリ、ポータルコマンド。"
---

# idryer-coreとは何か、いつ使うか

デバイスをiDryerエコシステムに接続し、テレメトリ送信、コマンド受信、登録、MQTT通信を行いたい場合に `idryer-core` を使います。フィラメント乾燥機、加熱チャンバー、照明、センサー、3Dプリンター周辺モジュールに特に適しています。
