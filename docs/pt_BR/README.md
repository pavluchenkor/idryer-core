...
- `ArduinoWifiManager`, `ArduinoCredentialStore` e outras classes `Arduino*` — use conforme são, sem subclasses.
...
| [02-getting-started](02-quickstart/01-five-minutes.md) | Introdução rápida para um novo desenvolvedor: o que conectar, programar e esperar |
...
| [04-patterns/02-add-peripheral](04-patterns/02-add-peripheral.md) | Como adicionar um periférico e receber comandos |
