...
description: "Чеклист добавления нового устройства iDryer: профиль, команды, телеметрия, MQTT, портал и границы между библиотекой и продуктовым кодом."
---

# Как добавить новый продукт на базе idryer-core

Эта инструкция нужна, когда вы делаете новый продукт на базе `idryer-core`: сушилку филамента, нагревательный блок, подсветку, датчик или другой модуль. Она показывает, что должно остаться в библиотеке, а что описывается в коде конкретного устройства.
