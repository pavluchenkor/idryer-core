...
Практический гайд: [10-how-to-add-product/01-add-new-product.md](10-how-to-add-product/01-add-new-product.md)
...
| [02-getting-started](02-getting-started.md) | Короткий вход для нового разработчика: что подключить, прошить, чего ожидать |
| [02-architecture/01-composition-root](02-architecture/01-composition-root.md) | Как продукт собирает стек: порядок создания объектов, паттерн main.cpp |
| [02-architecture/02-library-vs-product-boundary](02-architecture/02-library-vs-product-boundary.md) | Что живёт в библиотеке, что — в продукте |
| [02-architecture/03-data-flow](02-architecture/03-data-flow.md) | Поток данных в работающем устройстве: входящие команды, исходящие сообщения, связи |
| [03-mqtt/01-mqtt-client](03-mqtt/01-mqtt-client.md) | Класс `MqttClient`: конструктор, подключение, публикация |
| [03-mqtt/02-topics-and-messages](03-mqtt/02-topics-and-messages.md) | Все MQTT-топики: строки, payload, retained, QoS |
| [04-runtime/01-idryer-runtime](04-runtime/01-idryer-runtime.md) | `IdryerRuntime`: что координирует, какие команды обрабатывает |
| [05-uart/01-uart-layer](05-uart/01-uart-layer.md) | UART-бридж для двухпроцессорных устройств |
| [06-integrations/01-integrations-overview](06-integrations/01-integrations-overview.md) | Bambu, Home Assistant, Moonraker: подключение, ограничения |
| [07-platform-arduino/01-arduino-platform](07-platform-arduino/01-arduino-platform.md) | Arduino-реализации интерфейсов устройства |
| [08-profiles-and-products/01-profiles-model](08-profiles-and-products/01-profiles-model.md) | Интерфейс `IProfile`, колбэки, пример `LedStripProfile` |
