...
export interface Heartbeat {
  ...
  errorsSinceBoot: number;  /** RP2040 stub-шлёт 0. Реальные счётчики ошибок ведутся на ESP32. */
...
export interface ClaimStatus {
  ...
  pin: string;
  expiresAt?: number;  /** В current code-paths producer'а нет: cloud claim callback экспонирует только pin */
