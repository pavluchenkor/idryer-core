...
Auto-generated scaffold. Capabilities: **heater, fan**.
...
4. Build and flash: `pio run -e iheater_link-prod --target upload`
...
of `IheaterLinkProfile`. The yaml only describes the interface
